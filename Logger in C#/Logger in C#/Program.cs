namespace Logger_in_C_
{
    ...
    public class FileLogger : ILogger
    {
        public void Log(string message)
        {
            ...
            string directoryPath = @"C:\...\Logging Text"; // Path when I want create txt file
    ...
    /*
    Decoupling: 
    The Application class depends on the ILogger interface rather than specific implementations like FileLogger or DatabaseLogger. 
